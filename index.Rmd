...
style_used_df = data.frame(style_id = every_style, amount_used__or_missing = every_style_used_pcs, initial_amount = every_style_sum_initial)

top_10_used_styles = style_used_df[order(style_used_df$amount_used__or_missing, decreasing = TRUE), ][1:10, c(1,2)]
top_10_used_styles
```
```{r}
ggplot(top_10_used_styles, aes(x = style_id, y = amount_used__or_missing)) +
